...
public class CourseManager {
    ...
    @Nullable
    public CourseComponent getCourseComponentById(@NonNull String blocksApiVersion,
                                                  @NonNull String courseId,
                                                  @NonNull String componentId) {
        CourseComponent courseComponent = getCourseDataFromPersistableCache(blocksApiVersion, courseId);
        if (courseComponent == null)
            return null;
        return courseComponent.find(new Filter<CourseComponent>() {
            @Override
